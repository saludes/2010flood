...
\title{GEMT 2010:  Flooding of the River Ebro}
\author{Jeff Springer, Manuel Quezada}
...
\newcommand{\enqu}{\end{equation*}}

\newcommand{\beqn}{\begin{eqnarray} }
\newcommand{\enqn}{\end{eqnarray}}

\newcommand{\beqnu}{\begin{eqnarray*} }
\newcommand{\enqnu}{\end{eqnarray*}}
...
\numberwithin{figure}{section}  %serveix perqu? les figures i les equacions les numeri a partir de la secci?
...
Thus, we can bound \begin{tiny}(this may be useful if we could compare it with B... but we are not able to do so... we need $\rho$ in order to be able to say something)\end{tiny} the cost of strategy A as
\beq
